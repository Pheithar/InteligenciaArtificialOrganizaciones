...
model_7_days_split = tf.keras.models.load_model('../output/model_7_days_split')
model_15_days_split = tf.keras.models.load_model('../output/model_15_days_split')
model_30_days_split = tf.keras.models.load_model('../output/model_30_days_split')
model_60_days_split = tf.keras.models.load_model('../output/model_60_days_split')
...
title_kfold = "CROSSVALIDATION"
title_split = "SPLIT PERCENTAGE"
...
(spain_7_pred1_split, spain_7_pred2_split, spain_7_pred3_split) = predictions_3(model_7_days_split, spain_7_days)
(brazil_7_pred1_split, brazil_7_pred2_split, brazil_7_pred3_split) = predictions_3(model_7_days_split, brazil_7_days)
...
(spain_15_pred1_split, spain_15_pred2_split, spain_15_pred3_split) = predictions_3(model_15_days_split, spain_15_days)
(brazil_15_pred1_split, brazil_15_pred2_split, brazil_15_pred3_split) = predictions_3(model_15_days_split, brazil_15_days)
...
(spain_30_pred1_split, spain_30_pred2_split, spain_30_pred3_split) = predictions_3(model_30_days_split, spain_30_days)
(brazil_30_pred1_split, brazil_30_pred2_split, brazil_30_pred3_split) = predictions_3(model_30_days_split, brazil_30_days)
...
(spain_60_pred1_split, spain_60_pred2_split, spain_60_pred3_split) = predictions_3(model_60_days_split, spain_60_days)
(brazil_60_pred1_split, brazil_60_pred2_split, brazil_60_pred3_split) = predictions_3(model_60_days_split, brazil_60_days)
...
print("España predicción 1:", spain_7_pred1_split, "--- Error:", spain_7_pred1_split - real_values_spain[0])
print("España predicción 2:", spain_7_pred2_split, "--- Error:", spain_7_pred2_split - real_values_spain[1])
print("España predicción 3:", spain_7_pred3_split, "--- Error:", spain_7_pred3_split - real_values_spain[2])
print()
print("Brasil predicción 1:", brazil_7_pred1_split, "--- Error:", brazil_7_pred1_split - real_values_brazil[0])
print("Brasil predicción 2:", brazil_7_pred2_split, "--- Error:", brazil_7_pred2_split - real_values_brazil[1])
print("Brasil predicción 3:", brazil_7_pred3_split, "--- Error:", brazil_7_pred3_split - real_values_brazil[2])
...
print("España predicción 1:", spain_15_pred1_split, "--- Error:", spain_15_pred1_split - real_values_spain[0])
print("España predicción 2:", spain_15_pred2_split, "--- Error:", spain_15_pred2_split - real_values_spain[1])
print("España predicción 3:", spain_15_pred3_split, "--- Error:", spain_15_pred3_split - real_values_spain[2])
print()
print("Brasil predicción 1:", brazil_15_pred1_split, "--- Error:", brazil_15_pred1_split - real_values_brazil[0])
print("Brasil predicción 2:", brazil_15_pred2_split, "--- Error:", brazil_15_pred2_split - real_values_brazil[1])
print("Brasil predicción 3:", brazil_15_pred3_split, "--- Error:", brazil_15_pred3_split - real_values_brazil[2])
...
print("España predicción 1:", spain_30_pred1_split, "--- Error:", spain_30_pred1_split - real_values_spain[0])
print("España predicción 2:", spain_30_pred2_split, "--- Error:", spain_30_pred2_split - real_values_spain[1])
print("España predicción 3:", spain_30_pred3_split, "--- Error:", spain_30_pred3_split - real_values_spain[2])
print()
print("Brasil predicción 1:", brazil_30_pred1_split, "--- Error:", brazil_30_pred1_split - real_values_brazil[0])
print("Brasil predicción 2:", brazil_30_pred2_split, "--- Error:", brazil_30_pred2_split - real_values_brazil[1])
print("Brasil predicción 3:", brazil_30_pred3_split, "--- Error:", brazil_30_pred3_split - real_values_brazil[2])
...
print("España predicción 1:", spain_60_pred1_split, "--- Error:", spain_60_pred1_split - real_values_spain[0])
print("España predicción 2:", spain_60_pred2_split, "--- Error:", spain_60_pred2_split - real_values_spain[1])
print("España predicción 3:", spain_60_pred3_split, "--- Error:", spain_60_pred3_split - real_values_spain[2])
print()
print("Brasil predicción 1:", brazil_60_pred1_split, "--- Error:", brazil_60_pred1_split - real_values_brazil[0])
print("Brasil predicción 2:", brazil_60_pred2_split, "--- Error:", brazil_60_pred2_split - real_values_brazil[1])
print("Brasil predicción 3:", brazil_60_pred3_split, "--- Error:", brazil_60_pred3_split - real_values_brazil[2])
