...
\section{Validación del sistema}
  ...
  \subsection{Prueba PCR}
    ...
    \multicolumn{1}{|c|}{Regla 1} & 1.5 & 0.5 & 0.5 & 0 & 0.1 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 2} & 3.0 & 0.5 & 0.5 & 0 & 0.2 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 3} & 4.5 & 0.5 & 0.5 & 0 & 0.3 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 4} & 6.0 & 0 & 0.5 & 0 & - & 0.4 & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 5} & 7.5 & 0.5 & 0 & 0 & - & 0.5 & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 6} & 9.0 & 1.0 & 1.0 & 1.0 & 0.5 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 8} & 10.5 & 1.0 & 1.0 & 1.0 & 0.5 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 8} & 12.0 & 1.0 & 1.0 & 1.0 & 0.6 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 9} & 13.5 & 1.0 & 1.0 & 1.0 & 0.7 & - & - & - & - \\ \hline
    \multicolumn{1}{|c|}{Regla 10} & 15.0 & 1.0 & 1.0 & 1.0 & 0.8 & - & - & - & - \\ \hline
    \end{tabular}
    \end{center}
